import styles from "./scroll-hidden.module.scss";
import ScrollHiddenBanner from "components/ScrollHiddenBanner";
import React from "react";

/*TODO: 탑으로부터 일정 간격 되면 stick되는거 이상하고
왜 stick되는 그 구간에서만 display none이 되는지 모르겠음
*/
